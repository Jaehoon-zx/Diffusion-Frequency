...
#SBATCH --job-name=train_45 # Submit a job named "example"
#SBATCH --output=log_cifar10_ve_45.txt  # 스크립트 실행 결과 std output을 저장할 파일 이름
...
srun python main.py --config configs/ve/cifar10_crossvit.py --workdir workdir_cifar10_ve_45 --mode train