...
#SBATCH --job-name=eval_31 # Submit a job named "example"
#SBATCH --output=log_eval_cifar10_31.txt  # 스크립트 실행 결과 std output을 저장할 파일 이름
...
srun python main.py --config configs/ve/cifar10_ncsnpp.py --workdir workdir_cifar10_ve_31 --mode eval \
